        ...
        <div className="intro-grid">
          <ScrollReveal>
            <div className="intro-image">
              <img
                src={settings?.aboutImage ? (settings.aboutImage.startsWith('http') ? settings.aboutImage : UPLOAD_URL + settings.aboutImage) : 'https://images.unsplash.com/photo-1600607687939-ce8a6c25118c?w=800&q=85&auto=format&fit=crop'}
