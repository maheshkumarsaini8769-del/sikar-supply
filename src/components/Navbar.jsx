  ...
  return (
    <>
      ...
      <div className={`mobile-menu ${menuOpen ? 'open' : ''}`}>
        <div style={{ padding: '0 0 20px', borderBottom: '1px solid rgba(255,255,255,0.1)', marginBottom: '16px' }}>
          <Link
            to="/get-quote"
        ...
        {navLinks.map(item => (
          <a
            ...
            href={item.path}
            onClick={(e) => handleNavClick(e, item.path)}
            style={location.pathname === item.path ? { color: 'var(--color-accent)' } : undefined}
          >
            {item.label}
          </a>
        ))}
        <a href="/process" onClick={(e) => handleNavClick(e, '/process')}>Our 9-Step Process</a>
