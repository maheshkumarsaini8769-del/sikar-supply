      ...
      <nav className={`navbar ${scrolled ? 'scrolled' : ''} ${hidden ? 'navbar-hidden' : ''}`}>
        <div className="container">
          ...
          <div className="navbar-actions">
            ...
            <a href={`https://wa.me/${settings?.whatsapp || '918239409535'}?text=Hi%2C%20I%27m%20interested%20in%20your%20products`} target="_blank" rel="noopener noreferrer" className="navbar-whatsapp-btn">
          ...
          <div className="mobile-nav-right">
            ...
            <a href={`https://wa.me/${settings?.whatsapp || '918239409535'}?text=Hi%2C%20I%27m%20interested%20in%20your%20products`} target="_blank" rel="noopener noreferrer" className="mobile-whatsapp-btn" aria-label="WhatsApp">
