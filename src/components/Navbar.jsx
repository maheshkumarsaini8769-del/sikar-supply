        ...
        <div className="container">
          ...
          <div className="mobile-nav-right">
            ...
            <div className="navbar-quote-icon">
              <a href="https://wa.me/918239409535?text=Hi%2C%20I%27m%20interested%20in%20your%20products" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp">
      ...
      <div className={`search-overlay ${searchOpen ? 'open' : ''}`} onClick={() => setSearchOpen(false)}>
        <div className="search-box" onClick={e => e.stopPropagation()}>
          <form onSubmit={handleSearch}>
            <input type="text" placeholder="Search products, materials..." value={searchQuery} onChange={e => setSearchQuery(e.target.value)} />
