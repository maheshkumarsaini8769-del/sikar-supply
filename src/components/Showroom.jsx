        ...
        <div className="showroom-grid">
          <ScrollReveal direction="left">
            <div className="showroom-image">
              <img
                src={settings?.showroomImage ? (settings.showroomImage.startsWith('http') ? settings.showroomImage : UPLOAD_URL + settings.showroomImage) : 'https://images.unsplash.com/photo-1600607687920-4e2a09cf159d?w=1000&q=85&auto=format&fit=crop'}
